        ...
        <div className="flex flex-col items-center mt-10 mx-4 md:flex-row-reverse md:justify-center md:mt-20 md:mx-32 ">
          ...
          <div className="mt-4 border-l-2 border-gray-300 flex flex-col gap-4 pl-4 md:mr-8 md:border-r-2 md:border-l-0 md:pr-4">
            ...
            <div className="flex flex-col gap-6 text-gray-500 ">
              ...
              <p>
                + <u className="text-gray-800 ">SANGLES ET TOILES EN JUTE</u> :
          ...
          <div className="flex flex-col mt-4 text-1xl text-gray-500 font-light border-l-2  border-gray-300 pl-4 md:m-8 ">
            ...
            <div className="  flex flex-col gap-6 text-gray-500 ">
              ...
              <p>
                ...
                CARCASSE, AVEC LES RÉPARATIONS QUI PEUVENT S'AVÉRER NÉCESSAIRES
                ET UNE NOUVELLE <u className="text-gray-800">PATINE</u>;
              </p>
              <p>
                + LE <u className="text-gray-800">SANGLAGE</u> AVEC DES SANGLES
                DE JUTE, QUI FORME LE FOND DU SIÈGE;
              </p>
              <p>
              ...
              <p>
                ...
                PERMET D'APPORTER DU CONFORT PUISQU'UNE FINE COUCHE DE CRIN
                ANIMAL EST AJOUTÉE AVANT DE LA RECOUVRIR PAR UNE TOILE BLANCHE
                ET UNE COUCHE DE OUATE COTON;
              </p>
              <p>
