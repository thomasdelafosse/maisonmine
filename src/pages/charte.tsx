        ...
        <div className="w-full px-8 py-8">
          <div className="space-y-6 text-justify text-gray-600">
            ...
            <p>
              ...
              la vie privée des utilisateurs du site internet maisonmine.com (le
            ...
            <p>
              ...
              consultables ici :
              www.maisonmine.com/conditions-generales-de-vente.
            </p>
            ...
            <p>
              ...
              propos de ces Services exclusivement, en stricte conformité avec
              le RGPD.
            </p>
            ...
            <p>
              En vous enregistrant sur le Site, vous nous autorisez à traiter
            ...
            <p>
              ...
              de votre ordinateur, la date et l'heure de connexion, ainsi que
            ...
            <p>
              ...
              l'utilisation de Cookies tel que précisé au paragraphe 6
              ci-dessous.
            </p>
            ...
            <p>
              ...
              hors de l'Union Européenne. Nous ne partagerons jamais, sans avoir
            ...
            <p>
              ...
              numérique comportant des cookies du même émetteur. En tout état de
              cause, les cookies déposés sur votre terminal de navigation avec
              votre accord sont détruits 13 mois après leur dépôt sur votre
              terminal.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                ou à des produits, services ou informations que vous avez
                choisis sur notre Site (service souscrit, contenu d'un panier de
                commande, etc.) ;
              </li>
              <li>
                de vous permettre d'accéder à des espaces réservés et personnels
                de notre Site, tels que votre Compte, grâce à des identifiants
                ou des données que vous nous avez éventuellement antérieurement
            ...
            <p>
              ...
              sur vos données à caractère personnel.
            </p>
            ...
            <p className="mt-4">
              ...
              vous concernant, la rectification ou l'effacement de celles-ci. En
              outre, dans les limites posées par la loi, vous disposez également
              du droit de vous opposer au traitement, de le limiter, de décider
              du sort post-mortem de vos données, de retirer votre consentement
              à tout moment et du droit à la portabilité des données à caractère
              personnel fournies.
            </p>
            ...
            <p>
              ...
              Il est vous est donc recommandé de la consulter régulièrement. En
            ...
            <p>
              ...
              sur le site internet de la CNIL ou par courrier à l'adresse
