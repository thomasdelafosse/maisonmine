  ...
  return (
    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-30 flex gap-4 justify-center">
      ...
      >
        ...
        >
          <polygon
            points="371.92,0 321.862,220.524 74.776,220.524 74.776,284.19 74.776,512 138.453,512 138.453,284.19 315.455,284.19 315.455,512 379.12,512 379.12,255.925 437.224,0"
            fill="none"
            stroke="currentColor"
          />
        </svg>
      ...
      <button
        onClick={resetView}
        className="hidden md:block bg-white/80 p-2 rounded-md hover:bg-white/90 transition-colors shadow-md"
