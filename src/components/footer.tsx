    ...
    <footer className=" py-8 ">
      <div className="mx-4 md:mx-20 ">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:mt-10">
          <div className="flex flex-col space-y-4 items-center md:border-r-2 border-gray-300">
            <Image
          ...
          <div className="grid grid-cols-2 gap-2 items-center gap-y-6 md:mx-10 ">
            {navigation.map((item) => (
              <Link
                key={item.name}
                href={item.href}
          ...
          <div className="flex flex-row gap-2 justify-center items-center md:border-l-2 border-gray-300 pl-10">
            <a
